        ...
        <form method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    ...
                    <td></td>
                    <td><button id="saveBtn" name="submit" class="btn btn-success" type="submit">Save Changes</button><a href="<?php echo $backBtn?>"><button class="btn btn-warning" type ="button">Back</button></a></td>
                </tr>
            </table>
        </form>    
    </div>
